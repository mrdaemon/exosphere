...
def test_show_all_options(app_config):
    """
...
def test_show_specific_option(app_config):
    """
...
def test_show_option_not_found(app_config):
    """
...
def test_show_full_config(app_config):
    """
...
def test_show_full_config_with_option_warns(app_config):
    """
...
def test_source_shows_config_path(mocker, app_config):
    """
    Test that 'source' command shows the current configuration.
    """
    mocker.patch(
        "exosphere.commands.config.context", DummyContext(confpath="/tmp/config.yaml")
    )
...
def test_source_with_env(monkeypatch, app_config):
    """
...
def test_source_no_config(mocker, app_config):
    """
...
def test_paths_shows_directories(mocker, app_config):
    """
...
def test_paths_no_config(mocker, app_config):
    """
...
def test_diff_no_difference(app_config):
    """
...
def test_diff_with_changes(app_config_with_changes):
    """
...
def test_diff_full_with_changes(app_config_with_changes):
    """
