        ...
        with self._connection_state_lock:
            if self._connection is None:
                conn_args = {
                    ...
                    # use the Exosphere Runner
                    "config": Config(
                        overrides={"runners": {"remote": ExosphereRemote}}
                    ),
                }
                ...
                # Set the locale value for the runner to the configured
                # value (default is C)
                self._connection.exosphere_locale = self.ssh_locale
